...
You could run demos from [GitHub Pages for this repository.](https://htschan.github.io/generic-sensor-demos/)

## Demos description

### [Punchmeter](https://htschan.github.io/generic-sensor-demos/punchmeter/) ([code](https://github.com/htschan/generic-sensor-demos/tree/master/punchmeter))
...
### [Orientation phone](https://htschan.github.io/generic-sensor-demos/orientation-phone/) ([code](https://github.com/htschan/generic-sensor-demos/tree/master/orientation-phone))
...
### [360 degree beach panorama demo](https://htschan.github.io/generic-sensor-demos/websensor-panorama/) ([code](https://github.com/htschan/generic-sensor-demos/tree/master/websensor-panorama))
...
### [360 degree video demo](https://htschan.github.io/generic-sensor-demos/websensor-video/) ([code](https://github.com/htschan/generic-sensor-demos/tree/master/websensor-video))
...
### [Ambient Map demo](https://htschan.github.io/generic-sensor-demos/ambient-map/build/bundled/) ([code](https://github.com/htschan/generic-sensor-demos/tree/master/ambient-map/build/bundled))
...
### [Sensor Info demo](https://htschan.github.io/generic-sensor-demos/sensor-info/build/bundled/) ([code](https://github.com/htschan/generic-sensor-demos/tree/master/sensor-info/build/bundled))
...
### [VR Button demo](https://htschan.github.io/generic-sensor-demos/vr-button/build/bundled/) ([code](https://github.com/htschan/generic-sensor-demos/tree/master/vr-button/build/bundled))
...
### [Sensor tester](https://htschan.github.io/generic-sensor-demos/sensor-tester/build/bundled/) ([code](https://github.com/htschan/generic-sensor-demos/tree/master/sensor-tester))
...
If you have information about a security issue or vulnerability with an Intel-maintained open source project on https://github.com/htschan, please send an e-mail to secure-opensource@intel.com. Encrypt sensitive information using our PGP public key. For issues related to Intel products, please visit https://security-center.intel.com.
